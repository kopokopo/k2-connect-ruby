...
RSpec.describe(K2ConnectRuby::K2Entity::SettlementAccount) do
  describe "#add_settlement_account" do
    context "Adding my M-PESA phone" do
      context "Correct recipient details" do
        it "should send an add mobile wallet pay recipient request" do
          ...
          stub_add_merchant_wallet_request
          params = {
    ...
    context "Adding my bank account" do
      ...
      context "Wrong recipient details" do
        ...
        context "No settlement_method" do
          it "raises an error and does not send an add mobile wallet pay recipient request" do
            stub_access_token_request
            stub_add_merchant_bank_account_request
            params = {
        ...
        context "Wrong settlement method" do
  ...
  describe "#query_status" do
    context "for adding settlement accounts" do
